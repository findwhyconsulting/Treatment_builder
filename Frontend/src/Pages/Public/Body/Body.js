...
const Body = (content) => {
  ...
  const handlePhoneChange = (value) => {
    ...
    setErrors((prevErrors) => ({
      ...prevErrors,
      phone: phoneErrors.phone || "", // Remove error when fixed
    }));
  };
  ...
  const upperBody = () => {
    setSelectedImagePart("upperBody");
  };

  const midBody = () => {
    setSelectedImagePart("midBody");
  };

  const lowerBody = () => {
    setSelectedImagePart("lowerBody");
  };
                  ...
                  <form>
                    <div id="test-l-1" className="content">
                      ...
                      <p className="head-discrption">
                        ...
                        image that reminds you of your own body (or your own
                        body!).`}
                      </p>
                    ...
                    <div id="test-l-2" className="content">
                      ...
                      <p className="head-discrption d-none d-md-block">
                        {pageContent?.step2?.step2Description ||
                          `Click or tap on the areas of the body you’d like to
                        ...
                        <Col lg={6} className="accor-container">
                          ...
                          {selectedImagePart.length === 0 ? (
                            <div className="text-description">
                              <ol>
                                <li>
                                  Click or tap on a specific area of the body to
                            ...
                            <div>
                              ...
                              >
                                {["upperBody", "midBody", "lowerBody"].map(
                                  (tabKey) => (
                                    <Tab
                                      eventKey={tabKey}
        ...
        <Modal.Footer>
          <div className="step-footer">
            ...
            >
              ...
              <span
                style={{
                  color: pageContent?.buttonSettings?.buttonTextColor || "",
                }}
              >
                GO BACK
              </span>
          ...
          <Modal.Body className="text-center">
            ...
            <div id="take-one">
              ...
              <ul className="checkList instructions">
                <li>
                  Align your body to the on-screen guide, keeping it centered
                  and level.
                </li>
                <li>
                  Ensure even lighting on your body—avoid harsh shadows or
                  direct sunlight.
                </li>
                <li>
                  Remove glasses, hats, and hair that may cover your body.
                </li>
                <li>
